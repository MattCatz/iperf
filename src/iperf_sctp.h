 ...
 */
int
iperf_sctp_accept(struct iperf_test*);
 ...
 */
int
iperf_sctp_recv(struct iperf_stream*);
 ...
 */
int
iperf_sctp_send(struct iperf_stream*);

int
iperf_sctp_listen(struct iperf_test*);

int
iperf_sctp_connect(struct iperf_test*);
