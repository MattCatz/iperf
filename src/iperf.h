...
/* Minimum size UDP send is the size of two 32-bit ints followed by a 64-bit
 * int */
...
extern int gerror; /* error value from getaddrinfo(3), for use in internal
                      error handling */
...
/* In Reverse mode, maximum number of packets to wait for "accept" response -
