 ...
 */
int
iperf_tcp_accept(struct iperf_test*);
 ...
 */
int
iperf_tcp_recv(struct iperf_stream*);
 ...
 */
int
iperf_tcp_send(struct iperf_stream*) /* __attribute__((hot)) */;

int
iperf_tcp_listen(struct iperf_test*);

int
iperf_tcp_connect(struct iperf_test*);
